...
public final class SQLConstant { 
	...
	// 1.- Buscar las denominaciones existentes para la compa�ia a partir del company del usuario
	// SELECT p.denom, p.value FROM packing p WHERE p.company=<user.company>
	public final static String distributer_denominaciones =
			"SELECT p.denom, p.value FROM packing p WHERE p.company=?";

	//2.- Buscar rango de  la proxima Tarjeta Disponible para la compa�ia del ususario. (Para el distribuidor normal)
	...
	//******* QUERIES PARA RELLENAR EL CUBO DE REPORTE DE ANALISIS DE LIQUIDACI�N ******//	
	...
	//QUERIES NECESARIOS PARA LA CREACI�N DE DEPOSITO DUMMY.
	...
	//********************************************************************cubo de informaci�n de recargas*************************************************************
